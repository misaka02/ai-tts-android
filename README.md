...
> [!IMPORTANT]
> **🤖 本项目的全部底层架构、业务代码、UI 设计、单元测试与本份 README 文档均由 AI 智能体（Google DeepMind Antigravity）全自动自主构建与维护。**
> 
> * **实测范围说明**：本项目在真实生产环境中针对 **小米 MiMo** 与 **微软 Edge-TTS** 进行了深度调优与可用性验证，其余厂商按公开标准规范适配。
...
- **轻量界面与分体式架构**：
  - 界面纯净，遵循 Material 规范分级收纳；
  - 分体式架构：主程序仅 **2.26MB**，端侧 8.3MB JNI 运行组件按需独立加载，长久听书稳定省电。
...
| :--- | :--- | :--- | :--- |
| **🚀 开发测试预览版 (Preview)** | **最新开发测试版** (先行体验最新交互特性) | [高速镜像下载](https://ghfast.top/https://github.com/misaka02/ai-tts-android/releases/download/previous/ai-tts-engine-v3.8.7-google-material-clean.apk) | [GitHub Previous 专区](https://github.com/misaka02/ai-tts-android/releases/tag/previous) |
| **AI-TTS Engine 主程序** | **v3.9.0 正式版** (~2.26MB) | [高速镜像下载](https://ghfast.top/https://github.com/misaka02/ai-tts-android/releases/download/v3.9.0/ai-tts-engine-v3.9.0.apk) | [GitHub Releases](https://github.com/misaka02/ai-tts-android/releases/download/v3.9.0/ai-tts-engine-v3.9.0.apk) |
| **离线 JNI 运行时组件** | **ARM64 架构** (8.3MB，使用离线模型时需安装) | [高速镜像下载](https://ghfast.top/https://github.com/misaka02/ai-tts-android/releases/download/v3.9.0/ai-tts-offline-runtime-arm64.apk) | [GitHub Releases](https://github.com/misaka02/ai-tts-android/releases/download/v3.9.0/ai-tts-offline-runtime-arm64.apk) |
...
1. **配置音色**：打开应用，在在线大模型或离线模型库中选择心仪音色，点击试听按钮试听；
